...
QUESTIONS = [
    ...
    {"text": "8. Medicine қызық па?", "img": "https://images.unsplash.com/photo-1505751172876-fa1923c5c528?q=80&w=500"},
...
async def process_answer(callback: types.CallbackQuery):
    ...
    if q_idx + 1 < len(QUESTIONS):
        ...
        res = "IT және Технология 👨‍💻" if total >= 7 else "Менеджмент және Бизнес 💼" if total >= 4 else "Шығармашылық сала 🎨"
